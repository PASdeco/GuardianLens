...
export const demoScans: GuardianScan[] = [
  {
    ...
    assessment: {
      ...
      canonical_product_name: "Herbal Metabolism Capsules",
      canonical_manufacturer: "Northstar Naturals",
  ...
  },
  {
    ...
    assessment: {
      ...
      canonical_product_name: "Daily Immune Gummies",
      canonical_manufacturer: "Sample Health Co.",
      canonical_product_category: "SUPPLEMENT",
